    ...
    if (window.innerWidth > 760) {
      ...
      return (
        <div className="eve-mob">
          ...
          <div className="cat3-mob"></div>
          <div className="cat4-mob"></div>
          <div className="cat5-mob"></div>
          <div className="cat6-mob"></div>
          <div className="cat7-mob"></div>
          <div className="cat8-mob"></div>
          <div className="cat9-mob"></div>
          <div className="cat10-mob"></div>
          <div className="cat11-mob"></div>
        </div>
      );
    }
  }
