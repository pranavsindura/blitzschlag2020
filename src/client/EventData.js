const eventData = {
	flagship: {
		carImages: ['https://i.ibb.co/dBfpNTd/panache-for-site.jpg', 'https://i.ibb.co/nCVv2ns/bob-for-site.jpg'],
		content: [
			{
				heading: 'PANACHE',
			...
			},
			{
				...
				details: [`Venue: VLTC-407`, `Time: 1500 HRS`, `Date: 09/07/2020`, `Prizes worth: 30,000/-`],
	...
	mds: {
		carImages: ['https://i.ibb.co/vJy682r/Whats-App-Image-2020-01-10-at-16-08-02.jpg'],
		content: [
			{
				heading: 'Dhun',
	...
	literary: {
		carImages: ['https://i.ibb.co/s6h610x/Jenga-Se-Jawaab-3-page-001.jpg'],
		content: [
			{
	...
	fnp: {
		carImages: ['https://i.ibb.co/wNwkc1Z/Whats-App-Image-2020-01-08-at-14-19-55.jpg'],
		content: [
			{
	...
	// ,
	// finearts: {
	// 	carImages: ['https://i.ibb.co/MMWv7nc/Whats-App-Image-2020-01-12-at-21-45-14.jpg'],
	// 	content: [
	// 		{
	// 			heading: 'Test',
	// 			desc: `Edith Head, a renowned fashion designer, once said, "You can have anything you want in life if you dress for it." On that note, Blitzschlag 2020 brings you Panache, a fashion fiesta full of everything from old classics to the latest fads. So, if you're influenced by exemplars, or a trend-setter, this is your chance to take it to the next level. Do you have enough glam to light the ramp on fire?`,
