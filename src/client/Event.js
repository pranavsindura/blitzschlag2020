...
class Event extends Component {
  ...
  componentDidMount() {
    ...
    for (
      let i = 0;
      i < this.data.content[0].registerConstraints.minTeamSize;
      i++
    ) {
      ...
      <div>
        ...
        <ReactFullpage
          ...
          onLeave={(origin, dest, direction) => {
            ...
            // return false;
            if (dest.index == "2" && !this.data.content[currSlide].canRegister)
              return false;
          }}
                    ...
                    >
                      ...
                      >
                        <div className="other-infomob">
                          <p>
                            {this.data.content[currSlide].details.map(
                              (item, index) => {
                                return (
                                  <span>
                                    {item} <br />
                ...
                >
                  ...
                  <div className="formwrapper">
                    <h1 className="heading">
                      {this.data.content[currSlide].heading}
                    </h1>
